...
public enum Departement {
    ...
    private Departement(Integer department, String departmentName, String area, String prefecture) {
    ...
    public static ArrayList<String> getList(String format, Boolean sorted) {
